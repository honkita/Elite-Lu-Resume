...
\begin{paracol}{1}
  ...
  \cvevent{COMPSCI 3TB3 | Syntax-Based Tools and Compilers}{A+}{01 2025 -- 04 2025}{McMaster University}
  \begin{itemize}
  ...
  \begin{sloppypar}
    \cvtags{ARM, C, C\#, C++, CSS, Elm, Haskell, HTML, Java, JavaScript, Latex, Prolog, Python, R, SQL, Web Assembly}
  \end{sloppypar}
